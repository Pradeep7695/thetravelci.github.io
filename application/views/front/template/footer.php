<div class="wrapper-footer wrapper-footer-newsletter">
				...
				<aside class="col-sm-4 widget_text"><h3 class="widget-title">Quick Links</h3>
					<div class="textwidget">
						<ul class="menu list-arrow">
                            ...
                            <li><a href="<?= base_url('domestic_package')?>">Domestic Package </a></li>
					...
					<div class="textwidget">
						<div class="footer-info">
							...
							<ul class="contact-info">
								<li><i class="fa fa-map-marker fa-fw"></i> 207, 2nd Floor, Runwal Heights, LBS Marg, Opp. Nirmal Lifestyle, Mulund (W), Mumbai - 400080</li>
								<li><i class="fa fa-phone fa-fw"></i> +91-97024 83622 | 022-25600030</li>

								<li>
									<i class="fa fa-envelope fa-fw"></i><a href="mailto:info@thetravelfirm.in"> info@thetravelfirm.in</a>
								</li>
							</ul>
						</div>
                        ...
                        <aside id="text-5 social-media" class="widget_text">
                            <div class="textwidget">
                                <ul class="footer_menu">
                                    <li><a href="https://www.facebook.com/TheTravelFirm/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/thetravelfirm.in/" target="_blank"><i class="fa fa-instagram"></i></a>
                                    <li><a href="https://twitter.com/FirmTravel" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/the-travel-firm-871944188/" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </aside>
	...
	<div class="container wrapper-copyright">
		<div class="row">
			<div class="col-sm-6">
				<div><p class="copy-right-p">Copyright © 2019 The Travel Firm. All Rights Reserved.  Powered by <a href="https://www.itarsia.com" target="_blank">Itarsia India</a></p></div>
			</div>
			<div class="col-sm-6">
