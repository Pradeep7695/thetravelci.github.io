...
<div class="site wrapper-content">
	<div class="home-content" role="main">
     ...
     <!-- -------------------img slider -------------------- -->
									...
									<div class="radius-mask tour-block hover-aqua">
										...
										<div class="tour-caption">
											<div class="vertical-align">
												...
												<h4>stating from <b><i class="fa fa-inr"></i> <?= $item->package_price;?>/-</b></h4>
											</div>
		...
		<div class="section-white padding-top-6x padding-bottom-6x tours-type" id="destination-sec">
			<div class="container animatable fadeInUp">
				<div class="shortcode_title title-center title-decoration-bottom-center section-heading ">
					...
					<h3 class="title_primary animatable bounceInLeft">DESTINATION</h3>
					<h6 class="small-title animatable bounceInRight">Promising Memories for a Lifetime !</h6>
				</div>
		...
		<div class="padding-top-6x padding-bottom-6x bg__shadow section-background animatable fadeInUp">
			<div class="container">
				<div class="shortcode_title text-white title-center title-decoration-bottom-center">
					...
					<h3 class="title_primary animatable bounceInUp">Need Inspiration for Your Next Tour? Travel the World You Never Seen</h3>
				...
				<div class="row">
					<div class="col-sm-12 text-center padding-top-6x">
                     ...
                     <div class="front-map">
                         <div class="map-site">
                             <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15074.783813869826!2d72.9385334!3d19.1647819!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xcfdca594710f617f!2sThe+Travel+Firm!5e0!3m2!1sen!2sin!4v1556868908966!5m2!1sen!2sin" width="1500" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                         </div>
                     </div>
